    ...
    <div className="w-full flex flex-col">
      ...
      <div className="flex flex-col justify-center w-full sm:w-4/5 self-center p-4 sm:p-8 lg:p-12 xl:p-16">
        <h3 className="text-3xl sm:text-4xl font-medium text-gray-500 mb-2 sm:mb-4 p-0 tracking-normal flex justify-between text-center">
          Terms of Use
          <p className="text-base sm:text-lg text-gray-400">Last updated April , 2024</p>
        </h3>
        ...
        <p className="text-lg sm:text-xl text-gray-400">
          ...
          referred to as GALACTECH , we, us, our) hereby remind you to read and
          understand these Terms of Use (hereinafter referred to as this
          Agreement). This is a legal agreement between you and GALACTECH which
          governs your use of GALACTECH Software, Services and all the features
          and functions therein and any other related website or online offering
          whether accessed via a computer or a mobile device or through any
          other technology, manner or means. For proper use of GALACTECH system
          and software (hereinafter collectively referred to as the Software)
          and GALACTECH services (hereinafter collectively referred to as the
          Service), please read carefully and fully understand the terms and
          conditions herein before you use your GALACTECH device or download a
          Software mentioned in this Agreement, especially the Disclaimers,
          Limitation of Liabilities, Privacy Policy, Usage Rules, Applicable
          Law, Dispute Resolution and other sections which may have been
          highlighted in bold or in capital letters for your attention.
        </p>
